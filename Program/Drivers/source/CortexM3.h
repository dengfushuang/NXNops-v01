...
/* NVIC Registers */
#define NVIC_INT_TYPE           REG32(0xE000E004)  //中断控制类型寄存器 
#define NVIC_ST_CTRL            REG32(0xE000E010)  //系统时钟节拍（SysTick）控制与状态寄存器
#define NVIC_ST_RELOAD          REG32(0xE000E014)  //系统时钟节拍（SysTick）重装值寄存器
#define NVIC_ST_CURRENT         REG32(0xE000E018)  //系统时钟节拍（SysTick）当前值寄存器
#define NVIC_ST_CALIB           REG32(0xE000E01C)  //系统时钟节拍（SysTick）校准值寄存器
#define NVIC_ENABLE0            REG32(0xE000E100)  //Irq0～31 使能设置寄存器  
...
#define NVIC_ENABLE7            REG32(0xE000E11C)  //Irq224～239 使能设置寄存器 
#define NVIC_DISABLE0           REG32(0xE000E180)  //Irq0～31 使能清除寄存器 
...
#define NVIC_DISABLE7           REG32(0xE000E19C)  //Irq224～239 使能清除寄存器
#define NVIC_PEND0              REG32(0xE000E200)  //Irq0～31挂起设置寄存器 
...
#define NVIC_PEND7              REG32(0xE000E21C)  //Irq224～239挂起设置寄存器 
#define NVIC_UNPEND0            REG32(0xE000E280)  //Irq0～31挂起清除寄存器 
...
#define NVIC_UNPEND7            REG32(0xE000E29C)  //Irq224～239挂起清除寄存器 
#define NVIC_ACTIVE0            REG32(0xE000E300)  //Irq 0～31激活位寄存器 
...
#define NVIC_ACTIVE7            REG32(0xE000E31C)  //Irq 224～239激活位寄存器 
#define NVIC_PRI0               REG32(0xE000E400)  //Irq 0～31优先级寄存器 
...
#define NVIC_CPUID              REG32(0xE000ED00)  //CPUID基址寄存器 
#define NVIC_INT_CTRL           REG32(0xE000ED04)  //中断控制状态寄存器 
#define NVIC_VECT_TABLE         REG32(0xE000ED08)  //向量表偏移寄存器 
#define NVIC_AP_INT_RST         REG32(0xE000ED0C)  //应用中断/复位控制寄存器 
#define NVIC_SYS_CTRL           REG32(0xE000ED10)  //系统控制寄存器 
#define NVIC_CFG_CTRL           REG32(0xE000ED14)  //配置控制寄存器 
#define NVIC_SYS_H_PRI4         REG32(0xE000ED18)  //系统处理器4-7优先级寄存器 
#define NVIC_SYS_H_PRI5         REG32(0xE000ED19)   
#define NVIC_SYS_H_PRI6         REG32(0xE000ED1A)  
#define NVIC_SYS_H_PRI7         REG32(0xE000ED1B)  
#define NVIC_SYS_H_PRI8         REG32(0xE000ED1C)  //系统处理器8-11优先级寄存器
#define NVIC_SYS_H_PRI9         REG32(0xE000ED1D)
#define NVIC_SYS_H_PRI10        REG32(0xE000ED1E)
#define NVIC_SYS_H_PRI11		REG32(0xE000ED1F)
#define NVIC_SYS_H_PRI12		REG32(0xE000ED20)  //系统处理器12-15优先级寄存器 
#define NVIC_SYS_H_PRI13        REG32(0xE000ED21)
#define NVIC_SYS_H_PRI14		REG32(0xE000ED22)
#define NVIC_SYS_H_PRI15		REG32(0xE000ED23) 
#define NVIC_SYS_H_CTRL         REG32(0xE000ED24)  //系统处理器控制与状态寄存器 
#define NVIC_FAULT_STA          REG32(0xE000ED28)  //可配置故障状态寄存器 
#define NVIC_HARD_F_STA         REG32(0xE000ED2C)  //硬故障状态寄存器 
#define NVIC_DBG_F_STA          REG32(0xE000ED30)  //调试故障状态寄存器 
#define NVIC_MM_F_ADR           REG32(0xE000ED34)  //存储器管理地址寄存器 
#define NVIC_BUS_F_ADR          REG32(0xE000ED38)  //总线故障地址寄存器 
#define NVIC_SW_TRIG            REG32(0xE000EF00)  //软件触发中断寄存器 
