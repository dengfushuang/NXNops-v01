...
void LPC1778_EEPROM_Init(void)
{
	 ...
	 * system bus clock.
	 */
   	cclk = SystemCoreClock;//CLKPWR_GetCLK(CLKPWR_CLKTYPE_CPU);
	val = (cclk/375000)-1;
...
void EEPROM_Write_Str(void* address, void* data, uint32_t count)
{
    ...
    address_temp = (uint8_t* )address  - &EEPROM_BASE_ADDRESS;
    EEPROM_Write(address_temp%64, address_temp/64, data, MODE_8_BIT, count);
}
...
void Save_To_EPROM(void* data, uint32_t count)
{
    ...
    address_temp = (uint8_t* )data  - &EEPROM_BASE_ADDRESS;
    EEPROM_Write(address_temp%64, address_temp/64, data, MODE_8_BIT, count);
}
...
{
    EEPROM_Read(address%64, address/64, data, MODE_8_BIT, count);
}
/*********************************************************************//**
