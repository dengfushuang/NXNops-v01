...
// prototypes
extern uint32_t LPC_EMAC_Init(void);
extern uint8_t  EMAC_SendPacket(void *pPacket,uint32_t size);
extern uint16_t EMAC_ReadPacket(void);
extern void int_enable_eth (void);
extern void int_disable_eth (void);


#define MYMAC_1         0x48            /* our ethernet (MAC) address        */
#define MYMAC_2         0xA6            /* (MUST be unique in LAN!)          */
#define MYMAC_3         0xD2
#define MYMAC_4         0x00
#define MYMAC_5         0x00
#define MYMAC_6         0x99
...
#define CR_FULL_DUP         0x00000400  /* Full Duplex  该位被设为“1”表示在全双工模式下操作                     */
