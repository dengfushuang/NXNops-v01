...
#else
#define  RUN_LED_INIT    LPC_GPIO3->DIR |= (1<<3)
#define  RUN_LED_H       LPC_GPIO3->SET |= (1<<3)
#define  RUN_LED_L       LPC_GPIO3->CLR |= (1<<3)
#endif
